...
if ( ! function_exists('b5st_setup') ) {
	function b5st_setup() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => __( 'Small', 'mini-bootstrap5' ),
					'shortName' => __( 'S', 'mini-bootstrap5' ),
					'size'      => 14,
					'slug'      => 'small',
				),
				array(
					'name'      => __( 'Normal', 'mini-bootstrap5' ),
					'shortName' => __( 'M', 'mini-bootstrap5' ),
					'size'      => 16,
					'slug'      => 'normal',
				),
				array(
					'name'      => __( 'Large', 'mini-bootstrap5' ),
					'shortName' => __( 'L', 'mini-bootstrap5' ),
					'size'      => 22,
					'slug'      => 'large',
				),
				array(
					'name'      => __( 'Huge', 'mini-bootstrap5' ),
					'shortName' => __( 'XL', 'mini-bootstrap5' ),
					'size'      => 28,
					'slug'      => 'huge',
				),
			)
