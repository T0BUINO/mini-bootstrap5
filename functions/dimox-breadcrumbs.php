 ...
 */
 ...
 /*
	* With mini-bootstrap5 (Bootstrap 5) modifications; see //----mini-bootstrap5// {...} //----//
  ...
  */
	...
	$text['category'] = '收录于分类 "%s"'; // text for a category page
	$text['search']   = '查询 "%s" 的结果'; // text for a search results page
	$text['tag']      = '归类于标签 "%s"'; // text for a tag page
	$text['author']   = '由 %s 发布'; // text for an author page
